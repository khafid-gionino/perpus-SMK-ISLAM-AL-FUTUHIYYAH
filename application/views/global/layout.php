            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/logo.png" width="55px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <!-- <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/logo.png" alt="" srcset="">
        </div> -->
        <!-- <h3 class="header center white-text text-lighten-2 z-depth-5">PERPUSTAKAAN SMK ISLAM AL-FUTUHIYYAH</h3> -->
       

      </div>
    </div>
    <div class="parallax"><img  src="<?php echo base_url(); ?>assets2/img/sekolah2.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    by &copy; : <a href="#" target="_blank">SMKI AL-FUTUHIYYAH</a>
                </div>
