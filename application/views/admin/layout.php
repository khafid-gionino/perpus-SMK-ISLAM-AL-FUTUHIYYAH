...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>admin/Home" class="logo">
      ...
      <span class="logo-lg"><b>SMKI</b> al-futuhiyyah</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logo.png" alt="" srcset="" width="60px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="#">SMK ISLAM AL-FUTUHIYYAH</a>.</strong> 
  </footer>
